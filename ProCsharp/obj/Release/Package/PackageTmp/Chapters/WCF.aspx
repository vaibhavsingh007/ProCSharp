...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="SecondaryContent">
    <div>
        ...
        8. Added the WCF service reference for the URI net.tcp:<br />localhost:8523/Service1<br />
        9. Test the service.<br />
        <br />
        Reference:<br />
        <a href="http://msdn.microsoft.com/en-us/library/ff649818.aspx">
        http://msdn.microsoft.com/en-us/library/ff649818.aspx</a><br />
        <br />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        [DataContract(Namespace="<a 
            href="http:<br />www.thinktecture.com/SampleServices/2008">http:<br />www.thinktecture.com/SampleServices/2008</a>"]
        <br />
...
&nbsp;&nbsp;&nbsp; [DataMember] public DateTime StartDate { get; set; }<br />
        ...
        <br />
        [MessageContract] <br />public class ProcessPersonRequestMessage <br />{ 
        <br />[MessageHeader]&nbsp;&nbsp;&nbsp;&nbsp; &lt;-- Defines the data that goes 
        into the SOAP header.<br />public int employeeId; <br />[MessageBodyMember(Position=0)]&nbsp;&nbsp;&nbsp;&nbsp; 
        &lt;-- Defines what goes into the SOAP body with the position/order.<br />public Person person; <br />} 
        <br />
        <br />The class ProcessPersonRequestMessage is used with 
        the service contract that is defined with the 
        <br />
        <br />interface IProcessPerson : 
        <br />[ServiceContract] <br />public interface IProcessPerson <br />{ <br />[OperationContract] 
        <br />public PersonResponseMessage ProcessPerson( <br />ProcessPersonRequestMessage 
        message); <br />}<br />
        <br />
        <br />
        <br />
